...
public class TC_Login_Validations_002 extends BaseClass{
	...
	public void TC_GCodes_LoginValidations_002() throws InterruptedException
	{
		...
		String password2= reader.getCellData("Sheet1", "Password", 4);
		...
		String username3= reader.getCellData("Sheet1", "Username", 5);
		String password3= reader.getCellData("Sheet1", "Password", 5);
